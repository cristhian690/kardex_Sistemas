...
export declare type AllowedButtons = "next" | "previous" | "close";
...
export declare type DriverHook = (element: Element | undefined, step: DriveStep, opts: {
    config: Config;
    state: State;
    driver: Driver;
}) => void;

export declare type DriveStep = {
...
export declare type PopoverDOM = {
    wrapper: HTMLElement;
    arrow: HTMLElement;
    title: HTMLElement;
...
export declare type Side = "top" | "right" | "bottom" | "left" | "over";

export declare type StageDefinition = {
    x: number;
    y: number;
    width: number;
    height: number;
